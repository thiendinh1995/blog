import { Injectable, Inject, NgModuleFactoryLoader, Injector, ComponentFactory, NgModuleFactory } from "@angular/core";
import { Observable, throwError, from } from "rxjs";

import { DYNAMIC_COMPONENT_MANIFESTS, DYNAMIC_COMPONENT, DYNAMIC_MODULE } from "./component-manifest";
...
export class DynamicComponentLoaderService {
    ...
    loadFactory<T>(
        ...
        const componentFactory  = moduleRef.componentFactoryResolver.resolveComponentFactory<T>(dynamicComponentType);
